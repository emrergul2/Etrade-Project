...
namespace ETrade.Repository.Migrations
{
    ...
    [Migration("20220618214030_SeedsData-Brands")]
    partial class SeedsDataBrands
    {
            ...
            modelBuilder.Entity("ETrade.Core.Modals.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 5,
                            OrderDate = new DateTime(2022, 6, 19, 0, 40, 29, 789, DateTimeKind.Local).AddTicks(2874),
                            PaymentId = 1,
                            TotalPrice = 10m
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2022, 6, 19, 0, 40, 29, 789, DateTimeKind.Local).AddTicks(2920),
                            PaymentId = 2,
                            TotalPrice = 11.5m
                        });
                });
